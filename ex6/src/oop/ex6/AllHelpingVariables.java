...
//    public static final String ILLEGAL_END_MSG = "ERROR: the end bracket should be alone in a line!";
    ...
    public static final String IS_INT = "-?\\d+", IS_DOUBLE = "-?(\\d+.?\\d*)|(\\d*.\\d+)", IS_CHAR = "'.'", IS_STRING = "\".*\"", IS_BOOLEAN = IS_INT + "|" + IS_DOUBLE + "|" + TRUE + "|" + FALSE;
...
//            "\\s*" + TYPES + WHITE_SPACE_REGEX + VAR_NAME_REGEX + "\\s*" + SEMI_COLON + "\\s*";
    ...
    public static final String ASSIGN_2VARIABLE = "\\s*(?:final )?\\s*" +
